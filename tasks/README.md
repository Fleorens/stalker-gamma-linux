...
| T18 | Post-mortem de session : crash attribué au mod — ✅ livrée (2026-09-07) | **Opus 5**, effort élevé | T05, T12, T14 | 🟠 support |
| T19 | Steam / mode Gaming en un clic (`shortcuts.vdf`) — ✅ livrée (2026-09-08) | **Opus 5**, effort élevé | T06, T11 | 🟠 public Deck/Bazzite |
| T20 | MangoHud, gamescope/FSR, vkBasalt — ✅ livrée (2026-09-08) ; gamescope/FSR retiré depuis (2026-09-08), MangoHud/vkBasalt restent en couches optionnelles | **Opus 5**, effort maximal | T04, T05 | 🟠 avantage Linux |
| T21 | Cache de shaders conservé hors préfixe — ✅ livrée (2026-09-14) | **Sonnet 5**, effort moyen | T04, T05 | 🟡 première impression |
| T22 | Résilience ModDB : dépôt manuel, reprise ciblée — ✅ livrée (2026-09-14) | **Sonnet 5**, effort élevé | T03, T07, T12 | 🟠 installation bloquée |

Les six tâches de la phase sont livrées. Ordre réel : **T17** (2026-09-07,
plainte n°1 de GAMMA toutes plateformes — « *your modlist, settings, and mod
settings will reset* », wiki officiel — paquet `backups/` et fusion à trois
voies de `modlist.txt` à chaque update), puis **T18** le même jour (le code
était déjà écrit à 80 % depuis T15). Puis **T19** et **T20** le 2026-09-08
(T20 partiellement révisée le même jour : la couche gamescope/FSR a été
retirée, MangoHud et vkBasalt restent). **T21** et **T22** ferment la phase
le 2026-09-14.
